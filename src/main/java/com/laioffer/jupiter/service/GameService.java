...
public class GameService {
    private static final String TOKEN = "Bearer p5zvp9dqr6ql4iodko88eu60thd2uc";
    private static final String CLIENT_ID = "icz2phb8676x1eylw3e02ivno4v5im";
    ...
    private String buildGameURL(String url, String gameId, int limit) {
        if (gameId.equals("")) {
